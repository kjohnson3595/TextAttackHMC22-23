...
class Trainer:
    ...
    def _write_readme(self, best_eval_score, best_eval_score_epoch, train_batch_size):
        ...
        if isinstance(
            self.train_dataset, eukaryote.datasets.HuggingFaceDataset
            ...
            self.eval_dataset, eukaryote.datasets.HuggingFaceDataset
